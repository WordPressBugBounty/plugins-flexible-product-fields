...
namespace VendorFPF\Psr\Log\Test;

use VendorFPF\Psr\Log\LoggerInterface;
use VendorFPF\Psr\Log\LogLevel;
use VendorFPF\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('VendorFPF\Psr\Log\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('VendorFPF\Psr\Log\Test\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('VendorFPF\Psr\Log\Test\DummyTest', array('__toString'));
        }
