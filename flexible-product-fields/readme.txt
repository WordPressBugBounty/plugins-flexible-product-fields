...
* Fixed field price display in cart not respecting WooCommerce tax settings
* Fixed additonal fee in cart does not respect our compatibility with currency switching plugins

= 2.14.1 - 2026-03-04 =
* Fixed cart fee override for fields with same name

= 2.14.0 - 2026-03-03 =
* Added support for Flexible Product Fields - Multistep Configuration Addon
* Added support for WooCommerce 10.6
* Fixed displaying only first validation error when adding product to cart (now we display all the errors)
...
* Fixed default value for 'Radio with Images' field not applying correctly when the option value contained only digits.
...
* Added field duplication feature
* Fixed settings permissions: Changed from manage_options to manage_woocommerce
* Added support for WooCommerce 9.7

= 2.7.2 - 2025-02-06 =
* Fixed prevented assigning product images to multiselect field options.

= 2.7.1 - 2025-01-30 =
* Fixed cannot add html tags into html type field
...
* Fixed compatibility issues with currency switching plugins
* Fixed warnings about undefined array key in some cases
* Fixed js console error in multiselect field in some cases

= 2.6.4 - 2024-12-12 =
* Fixed fields group order

= 2.6.3 - 2024-12-07 =
* Added support for WooCommerce 9.5

= 2.6.2 - 2024-11-28 =
* Fixed an issue where products without tags were incorrectly assigned fields from templates linked to unrelated tags.
